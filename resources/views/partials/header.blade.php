                ...
                <li class="dropdown pc-h-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end pc-h-dropdown">
                        ...
                        <a class="dropdown-item" href="{{ route('auth.logout') }}"
                            onclick="event.preventDefault(); document.getElementById('logout-form-quick').submit();">
                                ...
                                <div class="card-body">
                                    <div class="flex gap-4">
                                        ...
                                        <div class="grow">
                                            ...
                                            <p class="mb-0">
                                                Lorem Ipsum has been the industry's standard dummy text of type and
                        ...
                        <div class="dropdown-body py-4 px-5">
                            <div class="profile-notification-scroll position-relative"
                                ...
                                <div class="grid my-3">
                                    ...
                                    <form id="logout-form-profile" action="{{ route('auth.logout') }}"
